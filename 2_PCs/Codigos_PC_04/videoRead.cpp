...
//*************************************************************		
		...
		putText(frame1, "A placa e:", Point(40,430), FONT_HERSHEY_SIMPLEX, 1, Scalar(0, 255, 0), 1);
		putText(frame1, placa, Point(240,430), FONT_HERSHEY_SIMPLEX, 1, Scalar(0, 255, 0), 1);
